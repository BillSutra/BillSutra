...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="border-t border-zinc-800 bg-[linear-gradient(180deg,#f7fbff_0%,#ffffff_100%)] py-14 text-foreground dark:bg-[linear-gradient(180deg,#09090b_0%,#111113_100%)]"
    >
      <div className="mx-auto w-full max-w-7xl px-6">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_repeat(4,minmax(0,1fr))]">
          <div className="space-y-4">
            <BrandLogo priority className="max-w-max" />
            <p className="max-w-sm text-sm leading-6 text-slate-600 dark:text-zinc-400">
            ...
            <div className="flex items-center gap-3 pt-1">
              <Link
                href="#linkedin"
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-blue-700 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 dark:text-blue-300"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-slate-600 dark:text-zinc-400">
              <li>
                <Link href="/pricing">{t("landing.footer.links.documentation")}</Link>
              </li>
              <li>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-slate-200 pt-6 text-sm text-zinc-500 dark:border-zinc-800 sm:flex-row sm:items-center sm:justify-between">
