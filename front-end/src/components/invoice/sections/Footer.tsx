...
const Footer = ({ data }: InvoiceSectionProps) => {
  ...
  return (
    <section
      ...
      style={style}
      data-template-block="footer"
    >
      <div className="grid gap-0 sm:grid-cols-[1fr_0.46fr]">
        <div
          className="min-h-24 border-b border-slate-200 px-5 py-4 sm:border-b-0 sm:border-r"
          data-part="closing-card"
        >
        ...
        <div className="flex min-h-24 items-center justify-center px-5 py-4">
          <div
            className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-6 py-5 text-center font-semibold text-slate-700"
            data-part="signature-card"
          >
